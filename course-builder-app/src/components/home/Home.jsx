  ...
  return (
    <section className="home">
      <div className="container1">
        <Stack direction={['column', 'row']} height="100%" justifyContent={["center", "flex-end"]} spacing={["16", "56"]} alignItems="center">
      ...
      >
        ...
        <Text textAlign={"center"} children="Find Valuable Content At Reasonable Price ..." />
        <Link to="/courses">
      ...
      <Box padding={"8"} bg={"blackAlpha.200"}>
          ...
          <HStack className='bannerBrands' justifyContent={"space-evenly"} marginTop={"4"}>
              <CgGoogle />
              <CgYoutube />
              <SiCoursera />
              <SiUdemy />
